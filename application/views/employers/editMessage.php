                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12 ho-so">
                            	<div class="col-md-12 col-sm-12 col-xs-12 margin-bottom no-padding">
    	                        	<form id="form-edit-message" class="" action="" method="post">
    	                                ...
    	                                <div class="row">
    	                                    ...
    	                                    <div class="col-md-9 col-sm-9 col-xs-12 form-group">
    	                                        <input type="text" name="name" class="form-control" placeholder="<?php echo $this->lang->line('Name')?>" value="<?php if(isset($getUserMessagesDefault))echo urldecode($getUserMessagesDefault->name);?>" />
    	                                    </div>
    	                                </div>
    	                                <div class="row">
    	                                    <div class="col-md-3 col-sm-3 col-xs-12 x8-15-b">
    	                                    ...
    	                                    <div class="col-md-9 col-sm-9 col-xs-12 form-group">
    	                                        <input type="text" name="title" class="form-control" placeholder="<?php echo $this->lang->line('Title')?>" value="<?php if(isset($getUserMessagesDefault))echo urldecode($getUserMessagesDefault->title);?>" />
    	                                    </div>
    	                                </div>
    	                                <div class="row">
    	                                    <div class="col-md-3 col-sm-3 col-xs-12 x8-15-b">
    	                                    ...
    	                                    <div class="col-md-9 col-sm-9 col-xs-12 form-group">
    	                                        <textarea class="form-control" id="content" name="content"
                                                      placeholder=""
                                                      rows="10"><?php echo set_value('content', isset($getUserMessagesDefault->content)?nl2br($getUserMessagesDefault->content):''); ?></textarea>
    	                                ...
    	                                <div class="row">
    	                                    <div class="col-md-2 col-md-offset-3 col-sm-3 col-offset-sm-3 col-xs-12">
    	                                        <button type="submit" name="submitEditMessage" value="submitEditMessage" class="btn btn-info"><?php echo $this->lang->line('Agree edit notifications'); ?></button>
    	                                    </div>
    	                                </div>
    	                            </form>
    	                        </div>
