            ...
            <div class="col-md-12 col-sm-12 col-xs-12 padding-top">
                <div class="my_job">
                    <div class="title_header">
                        <h3><?php echo $this->lang->line('Jobs save'); ?></h3>
                    </div>
                    <div class="body_mo">
                        <div class="row">
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="col-lg-3 text-center"><?php echo $this->lang->line('Date save'); ?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if(isset($listJobsSave)){
                                                            if ($listJobsSave->num_rows() > 0) {
                                                                foreach ($listJobsSave->result() as $job) {
                                                                    ?>
                                                                    <tr>
                                                                        <td class="xanh-14">
                                                                            <?php
                                        ...
                                        <div class="row">
                                            <div class="border-bottom">
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <a href="<?php echo  URL.$this->lang->line('l_detail').'/'.$job->alias.'-'.$job->id; ?>">
                                                        <?php echo $item->title; ?>
                                                    </a>
                                                </div>
                                            </div>
