                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="b1">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5 col-sm-5 col-xs-12">
                                                    <input type="text" class="form-control" name="title" required value="<?php echo set_value('title', isset($getResume->title)?$getResume->title:''); ?>"/><?php echo form_error('title') ?>
                                                </div>
                                                <div style="clear:both;"></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-md-3 col-sm-3 col-xs-12 control-label color-red"><?php echo $this->lang->line('ho va ten'); ?> <span>* </span><span><?php echo $this->lang->line('Security');?></span></label>
                                                <div class="col-md-5 col-sm-5 col-xs-12">
                                                    <input type="text" class="form-control border-color-red" name="fullname" required  value="<?php echo set_value('fullname', isset($getResume->fullname)?$getResume->fullname:''); ?>"/><?php echo form_error('fullname') ?>
                                                </div>
                                                <div style="clear:both;"></div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <div class="col-md-4 col-sm-4 col-xs-12 no-padding-left">
                                                        <div class='input-group date' id='datetimepicker_birthday'>
                                                            ...
                                                            if($birthday != ''){echo $birthday;} elseif(isset($getResume))if($getResume->birthday!=0) echo date('d/m/Y',$getResume->birthday); ?>" class="form-control" name="birthday" />
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-5 col-sm-7 col-xs-12">
                                                    <select class="form-control" name="country">
                                                        ...
                                                        foreach ($getCountry->result() as $item) {
                                                            if($country == $key || (isset($getResume->country) && $getResume->country == $key)){
                                                                $class='selected="selected"';
                                                            }
                                                            else{
                                                                $class='';
                                         ...
                                         <div class="row">
                                            <div class="form-group">
                                                <label class="col-md-3 col-sm-3 col-xs-12 control-label color-red"><?php echo $this->lang->line('Address'); ?> <span>* </span><span><?php echo $this->lang->line('Security');?></span></label>
                                                <div class="col-md-5 col-sm-5 col-xs-12">
                                                    <input type="text" class="form-control border-color-red" name="address" required  value="<?php echo set_value('address', isset($getResume->address)?$getResume->address:''); ?>"/><?php echo form_error('address') ?>
                                                </div>
                                                <div style="clear:both;"></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-md-3 col-sm-3 col-xs-12 control-label color-red"><?php echo $this->lang->line('Phone'); ?> <span>* </span><span><?php echo $this->lang->line('Security');?></span></label>
                                                <div class="col-md-5 col-sm-5 col-xs-12">
                                                    <input type="text" class="form-control border-color-red" name="cellPhone" required  value="<?php echo set_value('cellPhone', isset($getResume->cellPhone)?$getResume->cellPhone:''); ?>"/><?php echo form_error('cellPhone') ?>
                                                </div>
                                                <div style="clear:both;"></div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-5 col-sm-5 col-xs-12">
                                                    <select id="type" name="type" class="form-control edit-control">
                                                        ...
                                                        foreach ($default_cbPositionType as $key=>$value) {
                                                            ...
                                                            ?>
                                                            <option <?php echo $class; ?> value="<?php echo $key ?>" <?php echo $type; ?>><?php echo $value; ?></option>
                                                            <?php
                                                            # code...
                                                        }
                                                        ?>
                                        ...
                                        <h5><?php echo $this->lang->line('Detail resume'); ?></h5>
                                        <div id="b31">
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                                        ...
                                                        ?>
                                                        <span><?php echo $this->lang->line('Only supported file formats: * .doc, * .docx, * .pdf and size < 512 KB'); ?></span>
                                                    </div>
                                                    <div style="clear:both;"></div>
                                                </div>
                                            </div>
