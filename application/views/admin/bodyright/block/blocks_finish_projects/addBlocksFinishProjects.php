    ...
    <form action="<?php echo base_url();?>admin/blocks_finish_projects/check_add_blocks_finish_projects" method="post" id="from-tindang">
<input type="hidden" name="url" value="<?php echo $this->uri->segment(2);?>" id="url">
        <table class="TableGrid datatables" cellpadding="0" cellspacing="0" border="0" id="tbl_danhsachhoadon">
			...
			<?php
            $stt=1;
            foreach ($listBlocksNotFinishProjects as $row)
            { 
            ?>
