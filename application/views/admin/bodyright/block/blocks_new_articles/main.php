    ...
    <form action="<?php echo base_url();?>admin/blocks_new_articles/removeBlocksNewArticles" method="post" id="from-tindang">
        <table class="TableGrid datatables" cellpadding="0" cellspacing="0" border="0" id="tbl_danhsachhoadon">
            ...
            <thead>
                <tr>
                    ...
                    <th width="15%">
                        ...
                        <a class="them_new_article" href="<?php echo base_url();?>admin/blocks_new_articles/add_blocks_new_articles">Thêm tin tức</a>
			...
			<?php
            $stt=1;
            foreach ($listBlocksNewArticles as $row)
            { 
            ?>
