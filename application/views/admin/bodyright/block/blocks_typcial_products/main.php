    ...
    <form action="<?php echo base_url();?>admin/blocks_typcial_products/removeBlocksTypcialProducts" method="post" id="from-tindang">
        <table class="TableGrid datatables" cellpadding="0" cellspacing="0" border="0" id="tbl_danhsachhoadon">
            ...
            <thead>
                <tr>
                    ...
                    <th width="15%">
                        ...
                        <a class="them_typcial_products" href="<?php echo base_url();?>admin/blocks_typcial_products/add_blocks_typcial_products">Thêm dịch vụ</a>
			...
			<?php
            $stt=1;
            foreach ($listBlocksTypcialProducts as $row)
            { 
            ?>
