...
<div class="box">
    <div class="heading">
      <h1 style="float:left">Thêm city</h1>
    ...
    <div class="content">
      ...
      <div id="tab-order" class="vtabs-content">
          <form id="adminForm" action="<?php echo URL;?>admin/cities/check_add_cities" method="post" enctype="multipart/form-data">
          <input type="hidden" name="url" value="<?php echo $this->uri->segment(2);?>" id="url">
              <table class="table_admin">  
                  <tbody>
                        ...
                        <tr class="alt-row">
                          <td>Tên city:</td>
                          <td><input name="city_name" type="text" autofocus="autofocus"   /></td></tr>
                  </tbody>
               </table>
        </div>
