<div class="box">
    <div class="heading">
      <h1 style="float:left">Sửa danh mục</h1>
        	...
        	<input type="hidden" name="addCategory" value="<?php echo $this->uri->segment(2).'/viewCategorys';?>" id="url">
                <table class="table_admin">
                    <tbody>
                        ...
                        <tr class="alt-row">
                            <td>Tên danh mục:</td> 
                            <td><input name="category_name" type="text" autofocus value="<?php echo $category->category_name; ?>"   /></td>
                        </tr>
                        <tr class="alt-row">
                            <td>Parent:</td>
                            <td>
                                ...
                                foreach ($categories_parent->result() as $item) {
                                    ...
                                    ?>
                                    <option <?php echo $class; ?> value="<?php echo $item->id; ?>"><?php echo $item->category_name; ?></option>
                                    <?php
                                }
                                ?>
                                </select>
                        ...
                        <tr class="alt-row">
                            <td>Meta Title:</td> 
                            <td><input name="page_title" type="text"   value="<?php echo $category->page_title; ?>" /></td>
                        </tr>
                        <tr class="alt-row">
                            <td>Meta Keywords:</td> 
                            <td><input name="meta_keywords" type="text"    value="<?php echo $category->meta_keywords; ?>" /></td>
                        </tr>
                        <tr class="alt-row">
                            <td>Meta Description:</td> 
                            <td><input name="meta_description" type="text"   value="<?php echo $category->meta_description; ?>"  /></td>
                        </tr>
                    </tbody>
                </table>
      ...
      <div id="tab-payment" class="vtabs-content" style="display: none;">
            <table>
                <tbody>
                    <tr class="alt-row">
                        <td>Tên danh mục:</td> 
                        <td><input name="category_en_name" type="text" autofocus  value="<?php echo $category->category_en_name; ?>"  /></td>
                    </tr>
                </tbody>
            </table>
        </form>
