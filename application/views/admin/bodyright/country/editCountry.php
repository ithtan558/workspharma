...
<div class="box">
    <div class="heading">
      <h1 style="float:left">Sữa country</h1>
    ...
    <div class="content">
      ...
      <div id="tab-order" class="vtabs-content">
          <form id="adminForm" action="<?php echo URL;?>admin/country/check_edit_country/<?php echo $getCountry[0]->id;?>" method="post" enctype="multipart/form-data">
          <input type="hidden" name="url" value="<?php echo $this->uri->segment(2);?>" id="url">
              <table class="table_admin">  
                  <tbody>
                    ...
                    <tr class="alt-row">
                        <td>Tên country:</td>
                        <td><input name="country_name" type="text" autofocus="autofocus"  value="<?php echo $getCountry[0]->country_name;?>"  /></td></tr>
                    </tr>
                  </tbody>
               </table>
        </div>
