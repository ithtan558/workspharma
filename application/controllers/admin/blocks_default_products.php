...
class Blocks_default_products extends Admin_application{
	 ...
	 */
	 ...
	 public function __construct(){
		...
		$this->_data['blocks_default_products']=1;	
		...
		/*Load model*/
			...
			$this->load->Model("admin/block/m_blocks_default_products");
			$this->load->Model("admin/product/m_products");
...

	{
		...
		//sent data
			...
			$this->_data['template']='admin/bodyright/block/blocks_default_products/main';

		//get data

			$this->_data['listBlocksDefaultProducts']=$this->m_blocks_default_products->listBlocksDefaultProducts();
	...
	public function change_enable()
	{
		...
		$enable_products=$this->input->post('enable_products');
		if($enable_products!="")
		{
			$_SESSION['__enable_products__']=$enable_products;
		}
		$idProductsCategories=$this->input->post('idProductsCategories');
		if($idProductsCategories!="")
		{
			$_SESSION['__idProductsCategoriesTemp__']=$idProductsCategories;
			$stringIdProductsCategories=$this->m_products->stringIdProductsCategories($idProductsCategories);
			$stringIdProductsCategories.=$idProductsCategories;
			$stringIdProductsCategories=explode(',',$stringIdProductsCategories);
			$_SESSION['__idProductsCategories__']=$stringIdProductsCategories;
		}
	...
	public function add_blocks_default_products()

	{
		...
		//sent data
			...
			$this->_data['template']='admin/bodyright/block/blocks_default_products/addBlocksDefaultProducts';

			$this->_data['listProductsNotDefault']=$this->m_blocks_default_products->listProductsNotDefault();
			$this->_data['listProductsCategoriesCombobox']=$this->m_products->listProductsCategoriesCombobox();
	...
	public function check_add_blocks_default_products()
	...
	{					
...

			{
				...
				redirect(URL.'admin/blocks_default_products');

				foreach($_POST['add1'] as $id)

				{

					$data=array(

						'is_default_products' => 1

					);

					$this->m_blocks_default_products->addBlocksDefaultProducts($id,$data);
	...
	public function removeBlocksdefaultProducts()
...

			{
...

				{
					...
					$data=array(
						...
						'is_default_products' => 0

					);

					$this->m_blocks_default_products->removeBlocksdefaultProducts($id,$data);
	...
	public function edit_blocks($idBlocks_default_blockss)

	{
		...
		//sent data
			...
			$this->_data['template']='admin/bodyright/block/blocks/editBlocks_default_blockss';

		//get data

			$this->_data['listBlocksDefaultProducts']=$this->m_blocks_default_products->listBlocksDefaultProducts();

			$this->_data['listBlocks_default_blockssManufacture']=$this->m_blocks_default_products->listBlocks_default_blockssManufacture();

			$this->_data['getBlocks_default_blockss']=$this->m_blocks_default_products->getBlocks_default_blockss($idBlocks_default_blockss);
	...
	public function check_edit_blocks($idBlocks_default_blockss)

	{
...

			{
...

				{
					...
					$this->m_blocks_default_products->do_upload('fullimage'.$i.'_blocks');

				}

			}

			$this->m_blocks_default_products->do_upload1();
			...
			$this->m_blocks_default_products->editBlocks_default_blockss($idBlocks_default_blockss,$data);
...

	{
		...
		//get data
			...
			$this->m_blocks_default_products->enable($enable,$id);
...

	{
		...
		//get data
			...
			$this->m_blocks_default_products->enable_blocks($enable,$id);
	...
	public function removeBlocks_default_blockss()

	{
...

		{
...

			{
				...
				$this->m_blocks_default_products->removeBlocks_default_blockss($id);
